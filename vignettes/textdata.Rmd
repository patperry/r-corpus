...
## 	stem_dropped: FALSE
## 	stem_except: NULL
## 	combine:  chr [1:155] "A." "A.D." "a.m." "A.M." "A.S." "AA." ...
## 	drop_letter: FALSE
## 	drop_number: FALSE
## 	drop_punct: FALSE
## 	drop_symbol: FALSE
...
## 	drop_except: NULL
## 	sent_crlf: FALSE
## 	sent_suppress:  chr [1:155] "A." "A.D." "a.m." "A.M." "A.S." ...
```
...
```
## Error in as_text.character(x): argument entry 1 is marked as "UTF-8" but contains an invalid byte in position 3 (\xe7)
```
