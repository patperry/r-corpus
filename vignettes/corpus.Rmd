...
The decision of whether to include or exclude "heart" is a difficult judgement
...
describes objects. There it does not describe or evoke emotion.
...
```r
affect <- subset(affect, !term %in% c("down", "great", "like",
                                      "yellow", "near", "low", "blue"))
```
