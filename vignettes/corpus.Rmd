...
```
Error in eval(expr, envir, enclos): object 'witch' not found
```
...
```
Error in plot(i, witch, type = "l", xlab = "Segment", ylab = "Rate × 1000", : object 'i' not found
```
...
```
Error in points(i, witch, pch = 16, cex = 0.5, col = 2): object 'i' not found
```
