...
```r
stem_list2 <- stemmer_make(term, stem)
```

```
Error in stemmer_make(term, stem): object 'term' not found
```
...
```
Error in text_tokens(text, stemmer = stem_list2): object 'stem_list2' not found
```
