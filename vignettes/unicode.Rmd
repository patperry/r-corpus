...
```
Error in knitr::knit("src/unicode.Rmd"): argument entry 15252 is marked as "UTF-8" but contains an invalid byte in position 36 (\xa3)
```
...
If you need more than reading in a single file, the [readtext][readtext]
