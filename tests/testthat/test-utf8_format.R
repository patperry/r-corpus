...
test_that("'format' can handle long text in UTF-8 locale, part 2", {
    ...
    expect_equal(utf8_format(raw, chars = 1, justify = "none", na.encode = FALSE),
                 format(short, justify = "none", na.encode = FALSE))
