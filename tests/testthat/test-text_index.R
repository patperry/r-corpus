...
test_that("subset can drop unused sources", {
    x <- c(as_text("aaa"), as_text("b"), as_text("cc"))

    expect_equal(x[NULL], as_text(character()))
    expect_equal(x[1], as_text("aaa"))
    expect_equal(x[2], as_text("b"))
    expect_equal(x[3], as_text("cc"))
    expect_equal(x[c(1,2)], as_text(c("aaa", "b")))
    expect_equal(x[c(2,1)], as_text(c("b", "aaa")))
    expect_equal(x[c(1,3)], as_text(c("aaa", "cc")))
    expect_equal(x[c(3,1)], as_text(c("cc", "aaa")))
    expect_equal(x[c(2,3)], as_text(c("b", "cc")))
    expect_equal(x[c(3,2)], as_text(c("cc", "b")))
})
